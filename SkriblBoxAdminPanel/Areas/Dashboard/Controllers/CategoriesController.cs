    ...
    public class CategoriesController : Controller
    {
        ...
        public ActionResult Index(int? CategoryId)
        {
            try
            {
                ...
                {
                    var responseProduct = AsyncHelpers.RunSync<JObject>(() => ApiCall.CallApi("api/Admin/GetEntityById", User, null, true, false, null, "EntityType=" + (int)BasketEntityTypes.Category, "Id=" + CategoryId.Value));
                    ...
                    else
                    {
                        ...
                        model.ParentCategoryOptions = Utility.GetCategoryOptions(User, "None", model.Category.Id);
                    }
                }
                else
                {
                    model.ParentCategoryOptions = Utility.GetCategoryOptions(User, "None");
